...
/**
 * This class does all Token related Jobs:
 * 1) Token Generation
 * 2) Token Validation
 * 3) Refresh Token
 * 4) Claims extraction
 * 5) To check whether Token is expired?
 * 6) Can Token be refreshed.
 *
 * The Token generation strategy is based on JJWT by Stormpath.
 */
